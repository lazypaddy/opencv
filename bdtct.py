...
#changed for blue
cv2.createTrackbar('hmin', 'HueComp',101,179,nothing)
cv2.createTrackbar('hmax', 'HueComp',131,179,nothing)

cv2.createTrackbar('smin', 'SatComp',106,255,nothing)
cv2.createTrackbar('smax', 'SatComp',180,255,nothing)

cv2.createTrackbar('vmin', 'ValComp',60,255,nothing)
cv2.createTrackbar('vmax', 'ValComp',152,255,nothing)
